...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: Array<{
    ...
    priority: number;
      ...
      { path: "/championships", changeFrequency: "daily", priority: 0.9 },
      { path: "/college-stock-market-competition", changeFrequency: "weekly", priority: 0.95 },
      { path: "/stock-market-championship", changeFrequency: "weekly", priority: 0.95 },
      { path: "/virtual-stock-market-competition", changeFrequency: "weekly", priority: 0.9 },
      { path: "/corporate-stock-market-game", changeFrequency: "weekly", priority: 0.9 },
      { path: "/stock-market-simulation-for-colleges", changeFrequency: "weekly", priority: 0.9 },
      { path: "/finance-fest-stock-market-game", changeFrequency: "weekly", priority: 0.9 },
      { path: "/mba-stock-market-competition", changeFrequency: "weekly", priority: 0.9 },
      { path: "/school-stock-market-simulation", changeFrequency: "weekly", priority: 0.85 },
