          ...
          <div className="flex md:flex-row flex-col items-center justify-center md:gap-28 gap-8">
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              ...
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                ...
                <div>
                  <Link href="mailto:Arthhwise@gmail.com?subject=Contact%20from%20Arthwise%20Website" className="text-primary text-18 font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white">
                    Leave a message
                    <svg
                      width="23"
                      height="17"
            ...
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4 w-full">
              <div className="bg-heroBg dark:bg-search p-4 flex items-center justify-center rounded-full">
                <i className="bg-[url('/images/contact-page/Career.svg')] bg-no-repeat bg-contain w-9 h-9 inline-block"></i>
              </div>
              <div className="flex-1">
                <span className="text-midnight_text dark:text-white text-xl font-bold block mb-4">
                  Careers
                </span>
                <ComingSoon description="We're building an amazing team. Check back soon for career opportunities!" />
              </div>
            </div>
          </div>
          <div className="md:pt-32 pt-11 md:pb-28 pb-8">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.8217749023597!2d77.59374951519131!3d12.935244187362055!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae15f0d64a3c55%3A0x1234567890abcdef!2sANS%20Homes%2C%20Gulmohar%20Enclave%2C%20Bangalore%2C%20560037!5e0!3m2!1sen!2sin!4v1700000000000" width="1114" height="477" loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="rounded-lg w-full"></iframe>
          </div>
        </div>
