          ...
          <div className="grid lg:grid-cols-2 items-center gap-12">
            <div>
              <h2 className="md:text-35 sm:text-28 text-24 font-semibold text-midnight_text dark:text-white">
                Advanced
                <span className="text-primary max-w-max ml-2">Trading Tools</span>
              </h2>
              <p className="mt-6 text-base text-muted dark:text-white dark:text-opacity-70 lg:max-w-full sm:max-w-75%">
                Access institutional-grade analytics, charting tools, and market data to execute sophisticated trading strategies in a risk-free environment.
              </p>
              <Link
                href="/blog"
