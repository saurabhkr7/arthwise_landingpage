...
const Transparency = () => {
    return (
        <section className="pt-10 pb-20 lg:pt-20 lg:pb-[120px] dark:bg-darkmode" id="transparency">
            <div className="container mx-auto px-4 xl:px-0">
                <div className="bg-white dark:bg-midnight_text border border-grey/10 dark:border-white/5 shadow-testimonial rounded-2xl p-8 sm:p-10 lg:p-14 mb-[60px] text-center max-w-[800px] mx-auto">
                    ...
                    <p className="text-base text-body-color dark:text-white dark:text-opacity-70 mb-6">
                    ...
                    <p className="text-base text-body-color dark:text-white dark:text-opacity-70 mb-8">
